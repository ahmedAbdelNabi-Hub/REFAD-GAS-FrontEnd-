...
export class CarsComponent {
  ...
  public isCompanyDropdownOpen = signal(false);
  ...
  companyOptions = signal<IDropdown[]>([]);
  ...
  fetchCars() {
    ...
    if (this.companyId) {
      ...
      carFilter.status = this.selectedStatus() as 'active' | 'inactive';
    }
  ...
  exportToExcel() {
    this.carService.exportCarsToExcel()
      .pipe(takeUntil(this.destroy$))
      .subscribe({
        next: () => {
